...
>>>>>>> bdfedbb27f6c9eb7883d05d7d7ba1be0f09aed19
    ...
    [Test]
    public async Task CheckIfRandomIdTextIsDisplayed()
    {
        var randomIdText = await Page!.RandomIdText.TextContentAsync();
        Assert.That(randomIdText, Is.Not.Empty);
        Assert.That(randomIdText, Is.EqualTo(Page.RandomIdTextValue));
    }
    ...
    {
        await Expect(Page!.VisibleAfterButton).Not.ToBeVisibleAsync(new() {Timeout = 5030});
